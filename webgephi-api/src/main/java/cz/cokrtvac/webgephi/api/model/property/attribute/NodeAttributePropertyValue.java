...
public class NodeAttributePropertyValue extends AttributePropertyValue {
    public static final String TYPE = "nodeAttribute";

    public NodeAttributePropertyValue() {
    }

    public NodeAttributePropertyValue(String attributeId) {
