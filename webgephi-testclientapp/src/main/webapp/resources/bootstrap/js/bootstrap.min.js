...
+function (a) {
    ...
    }, a(document).on("click.bs.alert.data-model", b, c.prototype.close)
}(jQuery), +function (a) {
    "use strict";
    var b = function (c, d) {
    ...
    }, a(document).on("click.bs.button.data-model", "[data-toggle^=button]", function (b) {
        var c = a(b.target);
    ...
    }, a(document).on("click.bs.carousel.data-model", "[data-slide], [data-slide-to]", function (b) {
    ...
    }, a(document).on("click.bs.collapse.data-model", "[data-toggle=collapse]", function (b) {
    ...
    }, a(document).on("click.bs.dropdown.data-model", b).on("click.bs.dropdown.data-model", ".dropdown form",function (a) {
        a.stopPropagation()
    }).on("click.bs.dropdown.data-model", e, f.prototype.toggle).on("keydown.bs.dropdown.data-model", e + ", [role=menu]", f.prototype.keydown)
}(jQuery), +function (a) {
    "use strict";
    var b = function (b, c) {
    ...
    }, a(document).on("click.bs.modal.data-model", '[data-toggle="modal"]', function (b) {
    ...
    function b(c, d) {
        ...
        this.$element = a(c).is("body") ? a(window) : a(c), this.$body = a("body"), this.$scrollElement = this.$element.on("scroll.bs.scroll-spy.data-model", f), this.options = a.extend({}, b.DEFAULTS, d), this.selector = (this.options.target || (e = a(c).attr("href")) && e.replace(/.*(?=#[^\s]+$)/, "") || "") + " .nav li > a", this.offsets = a([]), this.targets = a([]), this.activeTarget = null, this.refresh(), this.process()
    }
    ...
    }, a(document).on("click.bs.tab.data-model", '[data-toggle="tab"], [data-toggle="pill"]', function (b) {
        b.preventDefault(), a(this).tab("show")
    })
}(jQuery), +function (a) {
    "use strict";
    var b = function (c, d) {
        this.options = a.extend({}, b.DEFAULTS, d), this.$window = a(window).on("scroll.bs.affix.data-model", a.proxy(this.checkPosition, this)).on("click.bs.affix.data-model", a.proxy(this.checkPositionWithEventLoop, this)), this.$element = a(c), this.affixed = this.unpin = null, this.checkPosition()
    };
