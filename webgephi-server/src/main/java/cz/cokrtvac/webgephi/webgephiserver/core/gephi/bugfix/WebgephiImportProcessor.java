...
/*
 ...
 /cddl-1.0.txt and /gpl-3.0.txt. If applicable, createOrUpdate the following below the
 ...
 However, if you createOrUpdate GPL Version 3 code and therefore, elected the GPL
...
/**
 * Fixes bugs in DefaultProcessor
 *
 * @author Vaclav Cokrt
 */
@ServiceProvider(service = Processor.class, position = 10)
public class WebgephiImportProcessor extends AbstractProcessor implements Processor {
    public String getDisplayName() {
        return NbBundle.getMessage(WebgephiImportProcessor.class, "WebgephiImportProcessor.displayName");
    }
