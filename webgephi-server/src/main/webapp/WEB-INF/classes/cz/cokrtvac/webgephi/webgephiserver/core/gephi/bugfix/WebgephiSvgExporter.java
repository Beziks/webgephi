 ...
 */
public class WebgephiSvgExporter implements CharacterExporter, VectorExporter, LongTask {
    ...
    public boolean execute() {
        PreviewController controller = new WebgephiPreviewController(workspace);
