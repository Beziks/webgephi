...
public class InitSingleton {
    ...
    private void insert() {
        ...
        User wrong = new User("wrong", "w", "www", "Wrong", "User");
        try {
            userDAO.createRegularUser(wrong);
            addDeaultGraph(wrong);
        } catch (ValidationException e) {
    ...
    private void addDeaultGraph(User user) {
        // Add graph
        GraphEntity e = new GraphEntity();
        e.setOwner(userDAO.getUserEntity(user.getUsername()));
